...
# Load sample files
pods_df_samp = feather.read_dataframe('interim/pods_samp.feather')
eps_df_samp = feather.read_dataframe('interim/eps_samp.feather')

# Load full files
eps_df = feather.read_dataframe('interim/eps.feather')
pods_df = feather.read_dataframe('interim/pods.feather')
